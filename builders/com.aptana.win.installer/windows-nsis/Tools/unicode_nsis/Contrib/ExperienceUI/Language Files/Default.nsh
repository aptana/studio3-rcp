...
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_WELCOMEPAGESTYLE2_TEXT_TOP "Welcome to the NSIS Setup Wizard for $(^Name)."
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_WELCOMEPAGESTYLE2_TEXT "Welcome to $(^Name) Setup.  This will install $(^Name) on your computer."
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_WELCOMEPAGESTYLE2_TITLE "Welcome"
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_WELCOMEPAGESTYLE2_SUBTITLE "Welcome to $(^Name) Setup."
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_WELCOMEPAGESTYLE2_CAPTION " "

!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_UNWELCOMEPAGESTYLE2_TEXT_TOP "Welcome to the NSIS Uninstall Wizard for $(^Name)."
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_UNWELCOMEPAGESTYLE2_TEXT "Welcome to $(^Name) Setup.  This will uninstall $(^Name) from your computer."
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_UNWELCOMEPAGESTYLE2_TITLE "Welcome"
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_UNWELCOMEPAGESTYLE2_SUBTITLE "Welcome to the $(^Name) Uninstaller."
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_UNWELCOMEPAGESTYLE2_CAPTION " "
...
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_STARTMENUPAGE_FOLDER     "$(^Name)"
...
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_UNSTARTMENUPAGE_TEXT     "Select the Start Menu folder in which to remove shortcuts from:"
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_UNSTARTMENUPAGE_CHECKBOX "Don't remove the Start Menu folder"
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_UNSTARTMENUPAGE_FOLDER   "$(^Name)"
...
!insertmacro XPUI_LANGUAGEFILE_DEFAULT XPUI_UNINSTCONFIRMPAGE_NSIS_TEXT_TOP "$(^Name) will be uninstalled from the following folder.  Click Next to start the uninstallation."
